...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<InstructorDeptView> InstructorDeptViews { get; set; }

    public virtual DbSet<InstructorTopicsView> InstructorTopicsViews { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=ITI;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Department>(entity =>
        {
            ...
            entity.ToTable("Department", tb => tb.HasTrigger("Trig_Prevent_Insert"));
        ...
        modelBuilder.Entity<InstructorDeptView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("InstructorDeptView");
        ...
        modelBuilder.Entity<InstructorTopicsView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("InstructorTopicsView");
        ...
        modelBuilder.Entity<Student>(entity =>
        {
            ...
            entity.ToTable("Student", tb =>
                {
                    tb.HasTrigger("trig1");
                    tb.HasTrigger("trig_isert_stud_audit");
                });
        ...
        modelBuilder.Entity<StudentAudit>(entity =>
        {
            ...
            entity.Property(e => e.ServerUserName).IsUnicode(false);
        });
